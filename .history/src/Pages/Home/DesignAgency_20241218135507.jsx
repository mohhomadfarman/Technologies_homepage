        ...
        <div className="md:flex md:items-center overflow-hidden relative">
          ...
          <Container className="relative">
            <Row className="full-screen md:h-[650px] ">
              ...
              >
                <h1 className="font-serif font-semibold text-[80px] leading-[95px] text-white drop-shadow -tracking-[4px] mb-[4.5rem] xs:w-[85%] lg:text-[80px] lg:leading-[90px] md:text-[50px] md:leading-[65px] sm:text-[35px] sm:leading-[43px] sm:-tracking-[.5px]">
                  AI is not in the<br/>
                  Future !!<br/>
                  It's happening<br/>
                  NOW !!<br/>
...
{/* what-we-do-start */}
        ...
        <section
          id="pricing"
          className="py-[120px] overflow-hidden border-b border-mediumgray lg:py-[90px]  sm:py-[80px] xs:py-[50px] bg-black"
        >
          <Container>
            <Row>
            ...
            <Row className="justify-center ">
              <Col lg={12}>
                <div>
                <p className="w-[100%] my-[35px] pr-2 lg:w-full">
                Technology Garage is your "one-stop shop" a
                place where you can dive deep into hands-on
                experiences, enhance your tech skills, and explore
                everything from the basics to more advanced
            ...
            <div className="border px-3 py-4 rounded-lg hover:shadow-lg transition-shadow duration-300 ease-in-out bg-wh hover:bg-white">
