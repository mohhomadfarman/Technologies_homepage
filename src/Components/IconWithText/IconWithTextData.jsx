...
const IconWithTextData_08 = [
    {
        ...
        title: "Robotics",
        content: "Learning starts with zero coding using Lego Spike Kits. Cue in the garage lets you bump up your exploration level with Block coding, JavaScript and more.",
    },
    {
        icon: "line-icon-Sand-watch2",
        title: "Coding",
        content: "There are no syntax, no books or papers. Our stories teach kids coding. A more inclusive and fun way to learn coding. Try it to believe it!",
    },
    {
        icon: "line-icon-Idea-5",
        title: "Artificial Intelligence",
        content: "Enough of hearing the buzz words, get hands on with Microsoft Cognitive Services at our Studio.",
    },
    
]
const IconWithTextData_080 = [
    {
        icon: "line-icon-Cursor-Click2",
        title: "Virtual Reality",
        content: "Learning VR starts with experiencing VR, explore the VR world at the Garage with world's best VR and content. Learn to create your own VR world at our Studio.",
    },
    {
        icon: "line-icon-Sand-watch2",
        title: "Cloud Computing",
        content: "No theory of cloud here. Get hands on with Microsoft Azure, AWS & GCP!",
    },
    {
        icon: "line-icon-Idea-5",
        title: "Internet of Things (IoT)",
        content: "We promote our kids and learners from Lego sensors to real world sensors. Gather data using Python and trigger specific actions.",
    },
...
export { IconWithTextData_01, IconWithTextData_02, IconWithTextData_03, IconWithTextData_04, IconWithTextData_05, IconWithTextData_06, IconWithTextData_07, IconWithTextData_08,IconWithTextData_080, IconWithTextData_09, IconWithTextData_10, IconWithTextData_11 }